...
<style type="text/css">
	...
	<?php if ( '' != $titlecolor || '' != $template_titlefontsize || '' != $titlebackcolor) { //phpcs:ignore ?>
		...
		.blog_template .bd_ad_container h4 {
			...
			<?php echo ( '' != $titlebackcolor) ? 'background-color: ' . esc_attr( $titlebackcolor ) . ' !important;' : ''; //phpcs:ignore ?>
